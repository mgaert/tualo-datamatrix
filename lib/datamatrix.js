...
Datamatrix.prototype.getDigit=function(text, opt){
	...
	var index = this.selectIndex(dataCWCount, this.options.rectangular); // Select the index for the data tables
	...
	datamatrix = this.next(0,rowsLengthMatrice,colsLengthMatrice, codeWordsBits, datamatrix);
